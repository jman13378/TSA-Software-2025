...
const GIT PASSWORD = "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"; // Replac const REPO URL = "https://github.com/PBMHS-TSA/TSA-Software-2025.git"; // Replace with your repository URL
Configure Git credentials git.addConfig("user.name", GIT_USERNAME);
...
if (platform === "win32") {
} command cmd /c "${command}""; else {
// For Unix-like systems (macOS, Linux), use bash to run the command command bash -c "${command":
}

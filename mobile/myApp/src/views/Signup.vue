        ...
        <ion-content class="ion-padding">
            ...
            <form novalidate @submit.prevent="onLogin">
                <ion-list style="border-radius: 10px;">
                    <ion-item>
                        <ion-input label="Username" labelPlacement="stacked" v-model="username" name="username"
                    ...
                    <ion-item>
                        <ion-button><ion-label>Forgot password?</ion-label></ion-button></ion-item>
                </ion-list>
                ...
                <ion-row responsive-sm class="ion-padding">
                    ...
                    <ion-col>
                        <ion-button  @click="$router.push('/signup')" color="light"

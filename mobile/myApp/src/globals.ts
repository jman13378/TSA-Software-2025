 ...
 */
 ...
 function sendNotification(title:string, body:string, icon:string = "../dist/img/logo.png", options = undefined) {
...
export {CredentialManager,playSound,sendNotification,socket}